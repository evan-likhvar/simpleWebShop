...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="panel panel-info">
                    <div class="panel-heading"><h3>Список</h3></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="well" style="background-color: #fff">
                        ...
                        <div style="width: 140px;">
                            <div style="width: 40px; float: left;">
                                <a class="btn btn-info btn-xs" role="button"
                                   href="{{route('admin.editPaper',$item->id)}}">Edit</a>
                            </div>
                            <div style="width: 40px; float: left;">
                                {!! Form::open(['method'=>'DELETE','action'=>['Admin\PaperController@PaperDestroy',$item->id]]) !!}
        ...
        {{ $paper->appends(Request::input())->links() }}
