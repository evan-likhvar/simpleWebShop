...
@section('content')
    ...
    <div class="panel-group">
        <div class="panel panel-info">
            <div class="panel-heading"><h3>Редактирование производителя <b>{{ $vendor->id }}</b> -- <b>{{ $vendor->name }}</b></h3></div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-2 ">
                {!! Form::open(['method'=>'POST','action'=>['Admin\VendorController@storeMedia',$vendor->id,'intro1'],'class'=>'dropzone']) !!}
                {!! Form::close() !!}
            </div>
            <div class="col-sm-3 ">
        ...
        <div class="row">
            ...
            @endif
            {!! Form::model($vendor, ['method'=>'PATCH','action'=>['Admin\VendorController@update',$vendor->id],'class'=>'form-horizontal']) !!}
