...
<div class="mailsub" style="width:640px;margin:0 auto">
    <table cellpadding="0" cellspacing="0" style="border:0;border-collapse:collapse;width:640px">
        <tr>
            <td style="text-align:left;padding:7px 0 10px;">
                Заявка от
            </td>
            <td style="text-align:left;padding:7px 0 10px;">
                {{$order->contact_name}}
        ...
        <tr>
            ...
            <td style="text-align:left;padding:7px 0 10px;">
                {{$order->payment_type==1 ? 'Наличными' : "Безнал"}}
            </td>
        </tr>
        <tr>
            <td style="text-align:left;padding:7px 0 10px;">
            ...
            <td style="text-align:left;padding:7px 0 10px;">
                <?php
                switch($order->shipment) {
                    case '1': echo 'Доставка к подъезду'; break;
                    case '2': echo 'Доставка с установкой'; break;
                    case '3': echo 'Самовывоз'; break;
                }
                ?>
    ...
    <table cellpadding="0" cellspacing="0" style="border:0;border-collapse:collapse;width:640px">
        <tr>
            <td style="width:640px;vertical-align:top">
                <table cellpadding="0" cellspacing="0"
                       style="border-left:1px solid #cccccc;border-right:1px solid #cccccc;border-top:3px solid #003399;border-collapse:collapse;width:100%">
                    <tr>
                        <td style="padding:25px 30px 20px 27px;vertical-align:top;border-bottom:1px solid #cccccc;">
                            <h1 style="font-size:28px;line-height:32px;padding-bottom:15px;font-weight:normal;margin:0">{{$order->contact_name}}
                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="http://www.куперхантер.укр{{\App\Article::find($row->article_id)->getIntroImg('XS')}}"
                                                                         border="0" width="80" height="51"
                                                                         alt="{{\App\Article::find($row->article_id)->name}}"
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="3"
                                                                                ...
                                                                                {{--{{$row->article_name}} --}}
                                                                                <a href="{{route('showArticle', ['article' => \App\Article::find($row->article_id)->getArticleLink()])}}"
                                                                                   target="_blank"
                                                                                   style="color:#3e77aa;font-size:15px;text-decoration:none;word-break:break-word;">{{\App\Article::find($row->article_id)->name}}</a>
                                                                                {{--{{\App\Article::find(1)->name}}--}}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            {{--<td style="font-size:15px;width:140px;vertical-align:top;padding-top:5px">{{$row->priceGRN}} грн</td>--}}
                                                                            <td style="font-size:15px;width:140px;vertical-align:top;padding-top:5px">{{number_format($row->priceGRN, 0,'', ' ')}}
                                                                                грн
                                                                            </td>
                                                                            <td style="font-size:15px;width:100px;vertical-align:top;padding-top:5px">{{$row->count}}
                                                                                шт.
                                                                            </td>
                                                                            <td style="font-size:18px;width:200px;vertical-align:top;text-align:right;color:#333333;padding-top:5px">{{number_format($row->priceGRN*$row->count, 0,'', ' ')}}
                                                                                грн
                                                                            </td>
                                                ...
                                                <td colspan="3"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-size:15px;vertical-align:top">{{$order->contact_name}}
                                                                , {{$order->phone}}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td colspan="3"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-size:26px;text-align:right;vertical-align:baseline">{{$total}}
                                                                грн
                                                            </td>
                                                        </tr>
                                                    </table>
        ...
        <tr>
            <td style="width:640px;vertical-align:top">
                <table cellpadding="0" cellspacing="0"
                       style="border-left:1px solid #cccccc;border-right:1px solid #cccccc;border-collapse:collapse;width:100%">
                    <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" style="border:0;border-collapse:collapse;width:100%">
                                <tr>
                                    <td style="width:68px;vertical-align:middle">
                                        <img src="http://www.куперхантер.укр/css/res/phone.png" alt="Телефон" width="48"
                                             height="48" style="border-width:0;display:block">
                                    </td>
                                    <td style="vertical-align:middle">
                                        <p style="margin:0;font-size:15px;line-height:24px">Будем рады ответить на Ваши
                                            вопросы:</p>
                                        <p style="margin:0;padding:0;font-size:15px;line-height:24px">{{$siteParameters['phone1']}}
                                            , {{$siteParameters['phone2']}}, {{$siteParameters['phone3']}}
                                            , {{$siteParameters['phone4']}}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
